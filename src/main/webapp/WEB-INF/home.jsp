...
<nav class="w3-top">
    <div class="w3-bar w3-white w3-card" id="myNavbar">
        ...
        <div class="w3-right w3-hide-small">
            ...
            <a class="w3-bar-item w3-button" href="/savedBooks">MY SAVED POSTS</a>
...
<div class="bgimg-1 w3-container" style="padding:128px 16px" id="team">
    ...
    <h3 class="w3-center">NEW POSTS EVERDAY</h3>
    <p class="w3-center w3-large">Find what you're looking for!!</p>
    <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
            <div class="w3-card">
                <div class="w3-container">
            <c:forEach var="book" items="${bookss}">
                       <div class="w3-row-padding w3-padding-64 w3-column-padding w3-padding-64">
                           <h3 class="alert alert-info w3-center"><strong><c:out value="${book.user.username}"/>  add a new post:</strong></h3>
                ...
                <div>
                    <c:if test="${ ! book.user.equals(user)}">
                        <c:choose>
                            <c:when test="${book.savers.contains(user)}">
                                <a class="btn btn-outline-info w3-center" href="/unsave/${book.id}">UnSave</a>
                            </c:when>
                            <c:otherwise>
                                <a class="btn btn-outline-info w3-center" href="/save/${book.id}">Save</a>
                            </c:otherwise>
                        </c:choose>
                    </c:if>
                </div>
