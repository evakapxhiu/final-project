...
<div class="w3-container bgimg-1 w3-padding-64">
    <div class="w3-row-padding">
        ...
        <div class="w3-col m6">
            <form:form action="/newPost" modelAttribute="exercise" class="form" method="post">
                <div class="form-row">
...
<%--            <label class="text text-primary">Subject:</label>--%>
<%--        </div>--%>
<%--        <div class="form-row">--%>
<%--            <input class="form-control" type="text" name="text"/>--%>
<%--            <label class="text text-primary">The problem:</label>--%>
<%--        </div>--%>
<%--        <div class="form-row">--%>
<%--            <input class="form-control" type="text" name="thoughts"/>--%>
<%--            <label class="text text-primary">Notes</label>--%>
<%--        </div>--%>
<%--        <div class="form-row">--%>
<%--            <input class="form-control" type="file" name="filee"/>--%>
